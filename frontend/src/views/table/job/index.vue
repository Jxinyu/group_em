...
const formRules: FormRules = reactive({
  ...
  remark: [{required: true, trigger: "blur", message: "请输入职位描述"}],
})
const handleCreate = () => {
...
const handleUpdate = (row: GetTableJobRequestData) => {
...
//#region 查
const tableData = ref<GetTableJobRequestData[]>([])
...
//region 查所有的部门
const options = ref<GetTableDeptRequestData[]>([])
const queryDept = ()=>{
...
const downLoadExcel = ()=>{
  ...
  getTableJobDataApi({
    ...
    .then((res) => {
      ...
      excelExport(res.data.data, 'sheet1', '职位')
    })
    .catch(() => {
  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        ...
        <el-form-item prop="remark" label="职位描述">
          <el-input v-model="searchData.remark" placeholder="请输入"/>
        </el-form-item>
        <el-form-item prop="dept" label="所属部门">
          <el-input v-model="searchData.dept" placeholder="请输入"/>
        </el-form-item>
        <el-form-item>
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          ...
          <el-button type="primary" :icon="CirclePlus" @click="dialogVisible = true">新增职位</el-button>
        </div>
        <div>
      ...
      <div class="table-wrapper">
        <el-table :data="tableData" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="remark" label="职位描述" align="center"/>
    ...
    <el-dialog
      ...
      :title="currentUpdateId === undefined ? '新增职位' : '修改职位'"
      @close="resetForm"
      width="30%"
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        <el-form-item prop="name" label="职业名称">
          <el-input v-model="formData.name" maxlength="20" minlength="10" show-word-limit placeholder="请输入"/>
        </el-form-item>
